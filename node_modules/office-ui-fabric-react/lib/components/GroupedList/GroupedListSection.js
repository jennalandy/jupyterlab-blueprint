...
var GroupedListSection = /** @class */ (function (_super) {
    ...
    GroupedListSection.prototype.render = function () {
        ...
        return (React.createElement("div", { ref: this._root, className: css(groupedListClassNames && groupedListClassNames.group, this._getDroppingClassName()), role: "presentation" },
            ...
            group && group.isCollapsed ? null : hasNestedGroups ? (React.createElement(List, { ref: this._list, items: group.children, onRenderCell: this._renderSubGroup, getItemCountForPage: this._returnOne, onShouldVirtualize: onShouldVirtualize, id: this._id })) : (this._onRenderGroup(renderCount)),
    ...
    GroupedListSection.prototype._onRenderGroup = function (renderCount) {
        ...
        return (React.createElement(List, tslib_1.__assign({ items: items, onRenderCell: this._onRenderGroupCell(onRenderCell, groupNestingDepth), ref: this._list, renderCount: Math.min(count, renderCount), startIndex: startIndex, onShouldVirtualize: onShouldVirtualize, id: this._id }, listProps)));
    };
