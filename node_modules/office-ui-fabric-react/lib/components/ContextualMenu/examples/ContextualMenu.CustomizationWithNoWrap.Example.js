...
var ContextualMenuCustomizationWithNoWrapExample = /** @class */ (function (_super) {
    ...
    function ContextualMenuCustomizationWithNoWrapExample() {
        ...
        _this._renderCharmMenuItem = function (item, dismissMenu) {
            return (React.createElement(IconButton, tslib_1.__assign({}, item, { iconProps: { iconName: item.text }, className: "ms-ContextualMenu-customizationExample-icon ms-ContextualMenu-link", "data-is-focusable": true, onClick: dismissMenu, "data-no-vertical-wrap": true })));
        };
        return _this;
    }
