...
import { BaseComponent, createRef, divProperties, findIndex, getFirstFocusable, getId, getLastFocusable, getNativeProps, mergeAriaAttributeValues, classNamesFunction, getDocument } from '../../Utilities';
    ...
    function DropdownBase(props) {
        ...
        _this._onRenderList = function (props) {
            ...
            return (React.createElement("div", { className: _this._classNames.dropdownItemsWrapper, onKeyDown: _this._onZoneKeyDown, onKeyUp: _this._onZoneKeyUp, ref: _this._host, tabIndex: 0 },
                React.createElement(FocusZone, { ref: _this._focusZone, direction: FocusZoneDirection.vertical, id: id + '-list', className: _this._classNames.dropdownItems, "aria-labelledby": id + '-label', role: "listbox" }, _this.props.options.map(function (item, index) { return onRenderItem(tslib_1.__assign({}, item, { index: index }), _this._onRenderItem); }))));
        };
        // Render items
