...
class JLButton extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(core_1.Button, { className: JLButtonStyle_1.JLButtonStyle((this.props.type) ? this.props.type : 'neutral', this.props.disabled), text: this.props.text, onClick: (event => this.props.onClick(event)) }));
    }
}
